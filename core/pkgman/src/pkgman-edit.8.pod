...
Edit the package I<FILE> from the package source directory using the
editor specified in the C<$EDITOR> environment variable.  If I<FILE>
is not specified, C<Pkgfile> is used.
