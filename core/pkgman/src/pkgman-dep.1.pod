...
B<pkgman> dep [B<-v>|B<-vv>] [B<--path>] [B<--all>] [B<--tree>]
[B<--recursive>] [B<--full>] I<PKGNAME>

=head1 DESCRIPTION

Print dependencies for a package.  It looks in all packages
