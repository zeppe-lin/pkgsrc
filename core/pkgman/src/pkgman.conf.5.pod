...
directories,
L<pkgman(1)|https://zeppe-lin.github.io/pkgman.1.html> will use the
one found first (directories listed first have precedence).
...
If set to I<yes>,
L<pkgman(1)|https://zeppe-lin.github.io/pkgman.1.html> will parse
version strings and prefer the higher one, even if the one found in
the packages sources directories is lower.  Influences I<diff> and
I<sysup> operations.
...
If set to I<yes>,
L<pkgman(1)|https://zeppe-lin.github.io/pkgman.1.html> will interpret
C<expr> and C<filter> patterns in I<list>, I<printf>, I<dsearch> and
I<fsearch> operations as regular expression.
...
L<pkgman(1)|https://zeppe-lin.github.io/pkgman.1.html> will notify the
user if installed package has a README file.
...
See
L<pkgman-readme(1)|https://zeppe-lin.github.io/pkgman-readme.1.html>
...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> for the command
which is used to build the package.
...
Use an alternate I<command> instead of
L<pkgadd(8)|https://zeppe-lin.github.io/pkgadd.8.html> for the command
...
Use an alternate I<command> instead of
L<pkgrm(8)|https://zeppe-lin.github.io/pkgrm.8.html> for the command
which is used to remove the package.
...
L<sh(1)|https://www.mankier.com/1p/sh> for the command which is used
to run the pre/post-install and pre/post-remove scripts.
