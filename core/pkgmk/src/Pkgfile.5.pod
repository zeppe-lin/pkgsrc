...
file is a L<sh(1)|https://www.mankier.com/1p/sh> script, which defines
...
sources structure, i.e. I</usr/src/pkgsrc/???/eterm>.
...
future versions of L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>
...
L<revdep(1)|https://zeppe-lin.github.io/revdep.1.html> to find
...
linked to, use L<ldd(1)|https://www.mankier.com/1/ldd> or
...
L<pkgman-rdep(1)|https://zeppe-lin.github.io/pkgman-rdep.1.html>).
...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>, the entire
F<Pkgfile> file has access to the variables initialized in
F<pkgmk.conf> and the default values set by
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>.  Also, as an
undocumented side effect of how it is used by
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>, it can also
change the behaviour of
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> by rewriting some
of its functions and variables while the current package is built.
However, the I<build> function has only read access to these mentioned
above.
...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>,
L<pkgmk.conf(5)|https://zeppe-lin.github.io/pkgmk.conf.5.html>
