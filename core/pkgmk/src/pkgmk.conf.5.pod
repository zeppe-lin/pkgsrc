...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>.  The file
...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> will take a
default action.
...
Set L<make(1)|https://www.mankier.com/1/make> options.
...
L<aria2c(1)|https://www.mankier.com/1/aria2c>, which is used by
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> to download all
files.
...
If set to C<yes>,
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> will not perform
a footprint check of the built package.  Valid string are C<yes> and
C<no>.
...
If set to C<yes>,
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> will not perform
a md5sum check of the source archives.  Valid string are C<yes> and
C<no>.
...
If set to C<yes>,
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> will ignore new
files in a footprint mismatch.  Valid string are C<yes> and C<no>.
...
If set to C<no>,
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html> will strip built
binaries.  Valid string are C<yes> and C<no>.
...
strings are C<gz>, C<bz2>, C<xz> and C<lz>.
...
L<pkgmk(8)|https://zeppe-lin.github.io/pkgmk.8.html>,
L<Pkgfile(5)|https://zeppe-lin.github.io/Pkgfile.5.html>
